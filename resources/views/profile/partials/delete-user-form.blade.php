<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Una volta eliminato l'account, tutte le risorse e i dati verranno eliminati permanentemente. Prima di eliminare il tuo account, scarica eventuali dati o informazioni che desideri conservare.") }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __("Una volta eliminato l'account, tutte le risorse e i dati verranno eliminati permanentemente. Inserisci la tua password per confermare l'eliminazione definitiva.") }}
                    </p>
                </div>
